...
class IsprsV(Base, ABC):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.labeled_image_paths = [
            os.path.join(self.data_path, "top/top_mosaic_09cm_area{}.tif".format(i))
            for i in [1, 3, 5, 7, 11, 13, 15, 17, 21, 23, 26, 28, 30, 32, 34, 37]
        ]
        self.unlabeled_image_paths = [
            os.path.join(self.data_path, "top/top_mosaic_09cm_area{}.tif".format(i))
            for i in [2, 4, 6, 8, 10, 12, 14, 16, 20, 22, 24, 27, 29, 31, 33, 35, 38]
        ]
        self.label_paths = [
            os.path.join(
                self.data_path,
