...
train_set = Subset(
    datasets.Resisc(data_path=data_path, img_aug=train_aug, nomenclature=nomenclature),
    indices=train_idx,
)

val_set = Subset(
    datasets.Resisc(data_path=data_path, img_aug=val_aug, nomenclature=nomenclature),
    indices=val_idx,
)

unsup_set = Subset(
    datasets.Resisc(data_path=data_path, img_aug=unsup_aug, nomenclature=nomenclature),
    indices=unsup_idx,
)
