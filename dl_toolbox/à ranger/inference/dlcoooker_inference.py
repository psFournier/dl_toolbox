...
class MyInferenceConfig(SemanticSegmentationInferenceConfig):
    image: ImageConf = ImageConf(
        path="/work/OT/ai4geo/DATA/DATASETS/DIGITANIE/Montpellier/Montpellier_EPSG2154_0.tif",
        bands=[1, 2, 3],
    )
    ...
    output: GeoTIFFOutputConf = GeoTIFFOutputConf(
        folder="/work/OT/ai4usr/hummerc/dlcooker_wrapper/",
        filename="Montpellier_EPSG2154_0",
        save_labels=True,
