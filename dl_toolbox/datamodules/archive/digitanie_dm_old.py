...
class DigitanieDm(LightningDataModule):
        ...
        datasets = [
            DigitanieDs(
                image_path=os.path.join(
                    self.data_path, city, city_lower + f"_{tile}_img_c.tif"
                ),
                label_path=os.path.join(
                    self.data_path, city, city_lower + f"_{tile}_c.tif"
                ),
                fixed_crops=False,
    ...
    def train_dataloader(self):
        train_sampler = RandomSampler(
            data_source=self.train_set, replacement=True, num_samples=self.epoch_len
        )
...
class DigitanieSemisupDm(DigitanieDm):
    ...
    def setup(self, stage=None):
        ...
        self.unsup_train_set = DigitanieDs(
            image_path=os.path.join(
                self.data_path, "Toulouse", "normalized_mergedTO.tif"
            ),
            fixed_crops=False,
