...
class LinearRamp:
    ...
    def __init__(self, start, end, start_val, end_val):
        self.fn = partial(lin_ramp, start=start, end=end, start_val=start_val, end_val=end_val)
...
class SigmoidRamp:
    ...
    def __init__(self, start, end, start_val, end_val):
        self.fn = partial(sigm_ramp, start=start, end=end, start_val=start_val, end_val=end_val)
