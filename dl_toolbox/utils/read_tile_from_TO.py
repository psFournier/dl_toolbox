...
print(minx)
(minx, maxx), (miny, maxy) = f_transform(dict(tile.crs), dict(big_raster.crs), [minx, maxx], [miny, maxy])
print(minx)
new_window = rasterio.windows.from_bounds(minx, miny, maxx, maxy, transform=big_raster.transform)
print(new_window)
