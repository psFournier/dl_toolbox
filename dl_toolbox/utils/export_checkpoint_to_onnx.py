...
def main():
    ...
    ckpt = torch.load(
        "/d/pfournie/ai4geo/outputs/digitanie/version_59/checkpoints/epoch=141-step=22293.ckpt",
        map_location=device,
    )
    ...
    ort_session = onnxruntime.InferenceSession(
        "test_semcity.onnx", providers=["CUDAExecutionProvider", "CPUExecutionProvider"]
    )
